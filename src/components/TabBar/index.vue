<!--
 * @Author: your name
 * @Date: 2019-10-21 14:12:09
 * @LastEditTime: 2019-10-21 15:17:04
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /c:\Users\Administrator\Desktop\bbb\bbb\src\components\TabBar\index.vue
 -->
<template>
<footer id="footer">
	<ul>
		<router-link tag="li" to="/movie">  <!--跳到指定的路由-->
